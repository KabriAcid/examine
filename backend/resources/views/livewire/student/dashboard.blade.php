    ...
    <div wire:loading.remove>
        ...
        <div wire:loading.remove class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2">
                <div wire:loading.remove class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-soft border border-white/20">
                ...
                <div wire:loading.remove class="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-soft border border-white/20 mt-8">
                    <div class="flex items-center justify-between mb-6">
                        <h3 class="text-xl font-bold text-spiritual-900">Subject Performance</h3>
                    </div>

                    <div x-data="subjectChart()" class="space-y-5">
                                        ...
                                        data: {
                                            ...
                                            datasets: [{
                                                ...
                                                borderColor: [
                                                    ...
                                                    'rgb(22, 163, 74)', // success-600
                                                    'rgb(217, 119, 6)' // warning-600
                                                ],
                                                borderWidth: 2,
                                                borderRadius: 8,
                                                borderSkipped: false,
