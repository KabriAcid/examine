                ...
                <div class="space-y-3 sm:space-y-4">
                    ...
                    <div class="border border-spiritual-200 rounded-lg sm:rounded-xl p-3 sm:p-4 hover:border-primary-300 hover:shadow-medium transition-all duration-300 group cursor-pointer flex flex-col">
                        ...
                        <button
                            ...
                            class="mt-3 sm:mt-4 w-full bg-gradient-to-r from-primary-500 to-primary-600 text-white py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-medium hover:shadow-medium transition-all duration-300 hover:scale-105 active:scale-95">
                            Start Exam
                        </button>
                    </div>
                    @empty
